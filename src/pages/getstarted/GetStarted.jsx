...
const GetStarted = () => {
  ...
  return (
    <div className="flex flex-col h-screen">
      <Navbar />
      <div className="ss:flex ss:px-20 px-8 ss:mt-20">
        <div className="pr-10">
          <GsContent
          ...
          {/* <CustomButton onClick={handleSnOpen}>Start Now</CustomButton> */}
          <button
            className="mt-10 md:mt-20 md:text-xl md:px-5 bg-purple px-4 py-2 rounded-md text-white font-semibold"
            onClick={handleSnOpen}
          >
            Start Now
          </button>
        </div>
        <div className="mt-10 ss:mt-0 mb-14 ss:mb-0 ss:ml-20">
          <GsContent
...
const GsContent = ({ heading, l1, l2, l3, l4 }) => {
  return (
    <div style={{ color: "#1D252D" }}>
      <div>
        <h3 className="text-2xl md:text-4xl font-semibold">{heading}</h3>
        <div className="flex mt-5 items-center">
          ...
          <p className="ml-3 text-lg md:text-xl">{l1}</p>
        </div>
        <div className="flex mt-4 items-center">
          ...
          <p className="ml-3 text-lg md:text-xl">{l2}</p>
        </div>
        <div className="flex mt-4 items-center">
          <div>
            <AiFillStar
          ...
          <p className="ml-3 text-lg md:text-xl">{l3}</p>
        </div>
        <div className="flex mt-4 items-center">
          <div>
            <AiFillStar
          ...
          <p className="ml-3 text-lg md:text-xl">{l4}</p>
        </div>
      </div>
    </div>
  );
